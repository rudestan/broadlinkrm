...
var knownDevices = []knownDevice{
	...
	knownDevice{deviceType: 0x7547, name: "Broadlink SC1 Switch", supported: true, ir: false, rf: false, power: true},
	knownDevice{deviceType: 0x2733, name: "Broadlink SP3-EU", supported: true, ir: false, rf: false, power: true},
